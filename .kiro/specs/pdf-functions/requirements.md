...
values, given by yj = C0j + x N × (C1j − C0j ), for 0 ≤ j < n .    24T
...
#### 0.4: 7.10.4          Type 3 (stitching) functions
...
boolean, and
bitwise operators          bitshift     ge           lt           or      xor
eq           gt           ne
