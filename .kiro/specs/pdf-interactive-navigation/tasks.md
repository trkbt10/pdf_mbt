...
- [x] 1. Establish shared navigation foundations
- [x] 1.1 Add navigation diagnostics and shared validation helpers
...
- [x] 1.2 Define catalog navigation model contracts
...
- [x] 1.3 Define page navigation model contracts
...
- [x] 1.4 Extend name-tree enumeration for navigation consumers
...
- [x] 1.5 (P) Add number-tree lookup for page labels
...
- [x] 1.6 (P) Expose page identity helpers needed by navigation
...
- [x] 2. Implement document-level navigation readers
- [x] 2.1 (P) Parse viewer preferences with ISO defaults
...
- [x] 2.2 (P) Parse explicit, structure, and named destinations
...
- [x] 2.3 Parse document outlines in display order
...
- [x] 2.4 (P) Parse page thumbnails as metadata descriptors
...
- [x] 2.5 (P) Parse portable collection metadata and navigators
...
- [x] 2.6 Traverse collection folders and associate files
...
- [x] 3. Implement page-level navigation readers
- [x] 3.1 (P) Parse page labels from number-tree ranges
...
- [x] 3.2 (P) Parse article threads and page bead references
...
- [x] 3.3 (P) Parse page presentation metadata
...
- [x] 3.4 Traverse sub-page navigation nodes
...
- [x] 4. Wire public reader facades and integration contracts
- [x] 4.1 Connect document-level navigation APIs to catalog readers
...
- [x] 4.2 Connect page-level navigation APIs to page readers
...
- [x] 4.3 Review public API surface and generated package interface
...
- [x] 5. Validate behavior, robustness, and non-regression
- [x] 5.1 Add component-focused white-box coverage
...
- [x] 5.2 Add cross-structure integration and regression coverage
...
- [x] 5.3 Run final toolchain validation
