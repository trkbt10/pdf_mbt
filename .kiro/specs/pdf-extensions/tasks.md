...
- [ ] 1. Establish extension reader foundations
- [ ] 1.1 Add extension-specific diagnostics and parse context
...
- [ ] 1.2 (P) Define public extension metadata models
...
- [ ] 2. Implement extension parsing and validation policies
- [ ] 2.1 Parse and compare extension version names
...
- [ ] 2.2 Parse developer extension dictionaries
...
- [ ] 2.3 Parse the outer Extensions dictionary and prefix forms
...
- [ ] 2.4 Validate extension level ordering and PDF 2.0-only entries
...
- [ ] 3. Integrate Catalog access and public API surface
- [ ] 3.1 Expose optional document-level extension access
...
- [ ] 3.2 Regenerate and review the reader public interface
...
- [ ] 4. Validate extension behavior with focused tests
- [ ] 4.1 Add valid dictionary and array coverage
...
- [ ] 4.2 Add malformed structure and directness coverage
...
- [ ] 4.3 Add version-policy and document integration coverage
...
- [ ] 5. Run final MoonBit validation
