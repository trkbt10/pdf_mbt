...
- [x] 1. Establish interchange package foundations
- [x] 1.1 Create shared interchange package boundary and diagnostics
...
- [x] 1.2 Define raw-preserving interchange value models
...
- [x] 2. Build document and object metadata core validators
- [x] 2.1 (P) Validate metadata stream shape and decoded XML payload
...
- [x] 2.2 Validate object-level metadata entries supplied by owners
...
- [x] 2.3 (P) Extract and validate document information dictionaries
...
- [x] 2.4 Compare metadata source presence and raw date equivalence
...
- [x] 2.5 Verify metadata and Info validators with unit tests
...
- [x] 3. Build identifier and page-piece validators
- [x] 3.1 (P) Expose file identifier comparison behavior
...
- [x] 3.2 (P) Validate page-piece dictionaries and private producer data
...
- [x] 3.3 Provide exact-byte page-piece date comparison helpers
...
- [x] 3.4 Verify file identifier and page-piece validators with unit tests
...
- [x] 4. Build content interchange validators
- [x] 4.1 (P) Validate predefined procedure set resource names
...
- [x] 4.2 (P) Normalize marked-content operands and property lists
...
- [x] 4.3 Track marked-content scope balance and text-object nesting
...
- [x] 4.4 Verify content interchange validators with unit tests
...
- [x] 5. Integrate document metadata and identifiers through reader
- [x] 5.1 Add reader error wrapping and package integration
...
- [x] 5.2 Expose catalog metadata, document information, and source diagnostics
...
- [x] 5.3 Expose trailer file identifiers through reader convenience access
...
- [x] 5.4 Verify reader metadata and file-id integration
...
- [x] 6. Integrate page-piece data across document, page, and form owners
- [x] 6.1 Expose Catalog and Page PieceInfo through reader APIs
...
- [x] 6.2 Preserve Form XObject PieceInfo in graphics-owned form validation
...
- [x] 6.3 Verify page-piece owner integration
...
- [x] 7. Integrate content analysis with existing resources and graphics behavior
- [x] 7.1 Expose procedure set and marked-content analysis over parsed content
...
- [x] 7.2 Confirm optional-content and future-feature handoff boundaries
...
- [x] 7.3 Verify content interchange integration
...
- [x] 8. Validate public API, regressions, and generated interfaces
- [x] 8.1 Regenerate package interfaces and review public surface
...
- [x] 8.2 Run full build and regression validation
