...
- [x] 1. Establish file-specification foundations
- [x] 1.1 Add file-specification diagnostics and resolved-object provenance
...
- [x] 1.2 Define public structural models and raw payload retention
...
- [x] 1.3 Create reusable file-specification fixture coverage
...
- [x] 2. Implement isolated clause 7.11 parsers
- [x] 2.1 Parse simple file-specification paths and pure resolution helpers
...
- [x] 2.2 (P) Describe embedded-file streams and parameter dictionaries
...
- [x] 3. Convert full file-specification dictionaries
- [x] 3.1 Parse file-system names and filename entries
...
- [x] 3.2 Integrate embedded-file mappings in full dictionaries
...
- [x] 3.3 Integrate related-file mappings and EF key consistency
...
- [x] 3.4 Preserve collection, thumbnail, encrypted-payload, and relationship metadata
...
- [x] 4. Wire public reader access and raw-boundary integration
- [x] 4.1 Parse raw file-specification operands on demand
...
- [x] 4.2 Enumerate document-level embedded files from the name tree
...
- [x] 4.3 Preserve adjacent raw hand-off behavior while exposing typed parsing
...
- [x] 5. Validate file-specification behavior and public integration
- [x] 5.1 Validate path and URL behavior with focused tests
...
- [x] 5.2 (P) Validate dictionary filename, URL, collection, encrypted-payload, thumbnail, and relationship behavior
...
- [x] 5.3 (P) Validate embedded-file and related-file behavior
...
- [x] 5.4 Validate accessor integration, name-tree enumeration, and raw-boundary compatibility
...
- [x] 5.5 Run final MoonBit validation and public API review
