...
- [ ] 1. Establish colour implementation prerequisites
- [ ] 1.1 Prepare package prerequisites for colour semantics
...
- [ ] 1.2 Establish initial-state inputs for typed colour interpretation
...
- [ ] 2. Build the core colour-space model
- [ ] 2.1 Model device spaces and shared component rules
...
- [ ] 2.2 Add calibrated CIE-based colour-space validation
...
- [ ] 2.3 Add special colour-space structural validation
...
- [ ] 2.4 Add DeviceN and NChannel attributes validation
...
- [ ] 2.5 Add ICCBased profile validation
...
- [ ] 3. Implement colour state and resource resolution
- [ ] 3.1 Store typed current stroking and nonstroking colour state
...
- [ ] 3.2 Resolve content colour-space names and default device remapping
...
- [ ] 3.3 Normalize colour values against the current colour space
...
- [ ] 4. Normalize colour-related graphics policies
- [ ] 4.1 Implement rendering intent and black point compensation semantics
...
- [ ] 4.2 Validate overprint state and nonzero overprint mode
...
- [ ] 4.3 (P) Classify colour-restricted interpretation contexts
...
- [ ] 5. Apply colour operators through the interpreter
- [ ] 5.1 Apply colour-space selection and convenience colour operators
...
- [ ] 5.2 Apply explicit colour-value operators
...
- [ ] 5.3 Integrate colour policy with ExtGState and shading handling
...
- [ ] 6. Update public integration surfaces
- [ ] 6.1 Publish typed colour state through graphics programs
...
- [ ] 6.2 Keep reader entry points aligned with the new graphics initial state
...
- [ ] 7. Validate colour behaviour and public API generation
- [ ] 7.1 Test colour-space parsing and validation coverage
...
- [ ] 7.2 (P) Test colour state and operator interpretation
...
- [ ] 7.3 (P) Test ExtGState colour policies and overprint semantics
...
- [ ] 7.4 Run repository validation and regenerate public interfaces
