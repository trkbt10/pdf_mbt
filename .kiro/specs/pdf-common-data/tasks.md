...
- [x] 1. Establish common-data package foundation
- [x] 1.1 Create the common-data package boundary and dependency manifest
...
- [x] 1.2 Define shared common-data values and diagnostics
...
- [x] 2. Implement common string qualifications
- [x] 2.1 Build PDFDocEncoding byte decoding
...
- [x] 2.2 Classify and decode text strings
...
- [x] 2.3 Scan Unicode language escape sequences
...
- [x] 2.4 Validate ASCII strings, byte strings, and text stream bytes
...
- [x] 2.5 Add focused common-data string tests
...
- [x] 3. Implement non-string common-data parsers
- [x] 3.1 Build PDF date parsing
...
- [x] 3.2 (P) Build rectangle validation
...
- [x] 3.3 (P) Build tree key and pair-array validation
...
- [x] 3.4 Add focused parser tests for dates, rectangles, and tree core
...
- [x] 4. Integrate common data into reader-owned traversal and facades
- [x] 4.1 Add reader error mapping and compatibility bridge
...
- [x] 4.2 Adopt common validation in reader document-hierarchy value helpers
...
- [x] 4.3 (P) Establish name-tree node shape and traversal safety
...
- [x] 4.4 Complete name-tree lookup and enumeration semantics
...
- [x] 4.5 (P) Establish number-tree node shape and traversal safety
...
- [x] 4.6 Complete number-tree ordering, enumeration, and lookup semantics
...
- [x] 4.7 Add reader integration tests
...
- [x] 5. Adopt common validation at downstream document-object boundaries
- [x] 5.1 Apply text and date validation to interchange-owned document metadata
...
- [x] 5.2 Apply rectangle validation to graphics document-object bounding boxes
...
- [x] 5.3 Add cross-package isolation tests
...
- [x] 6. Validate the complete feature and public API surface
- [x] 6.1 Run focused package validation
...
- [x] 6.2 Run project-wide build, formatting, and interface review
