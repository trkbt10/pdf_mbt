...
#### 0.3: 12.7.3            Interactive form dictionary
...
strings       widget annotation in the Kids array of the radio button or check box field.
...
#### 0.14: 12.7.5.5          Signature fields
...
strings                     within the signature policy. An empty string may be used
...
dictionaries specifying a Subject Distinguished Name (DN) that shall be
...
#### 0.16: 12.7.6.2         Submit-form action
...
specification giving the uniform resource locator (URL) of the script at the Web server
...
#### 0.17: 12.7.6.3          Reset-form action
...
#### 0.18: 12.7.6.4       Import-data action
...
string        result of an action, typically a submit-form action (see 12.7.6.2,
...
text stream        ECMAScript script that shall be executed just before the FDF
file is imported.
After                  text string or     (Optional) A text string or text stream containing an
text stream        ECMAScript script that shall be executed just after the FDF file
is imported.
AfterPermsReady        text string or     (Optional; PDF 1.6) A text string or text stream containing an
text stream        ECMAScript script that shall be executed after the FDF file is
...
#### 0.28: 12.7.8.3.4      FDF annotation dictionaries
...
#### 0.29: 12.7.9            Non-interactive forms
...
string         be a hexadecimal string (see 7.3.4.3, "Hexadecimal strings") representing the
...
array       signatures that use public-key cryptography, or a byte string if the chain has
...
#### 0.33: 12.8.2.2.2        Validating signatures that use the DocMDP transform method
...
SubFilter values            adbe.pkcs7.detached,             adbe.pkcs7.sha1c               adbe.x509.rsa_sha1a
...
RSA Algorithm Support       Up to 1024-bit (PDF 1.3)         See adbe.pkcs7.detached        See adbe.pkcs7.detached
...
#### 0.36: 12.8.3.2         PKCS #1 signatures
...
#### 0.38: 12.8.3.3.2      Revocation of CMS-based signatures
...
#### 0.40: 12.8.3.4.2      Signature dictionary for PAdES signatures
...
#### 0.41: 12.8.3.4.3      Attributes for PAdES signatures
...
#### 0.42: 12.8.3.4.4      Profiles of ETSI.CAdES.detached
...
#### 0.43: 12.8.3.4.5      Requirements for validation of PAdES signatures
...
#### 0.44: 12.8.3.4.6        Signature revocation checking model for PAdES signatures
...
#### 0.45: 12.8.3.4.7        Revocation checking PAdES signatures at the current time
...
#### 0.46: 12.8.3.4.8      Revocation checking PAdES signatures at a time in the past
...
#### 0.48: 12.8.4.2        Introduction to the document security store (DSS)
...
#### 0.49: 12.8.4.3         Document Security Store (DSS)
...
#### 0.50: 12.8.4.4          Validation-related information (VRI)
...
#### 0.51: 12.8.4.5           Usage of the DSS VRI
...
#### 0.53: 12.8.5.2        Initial document timestamp dictionary
...
#### 0.54: 12.8.5.3        Subsequent document timestamp dictionaries
...
#### 0.56: 12.8.7            Legal content attestations
...
string     explaining the presence of any of the other entries in this dictionary or
...
#### 0.58: 12.9.2           Algorithm: Use of a number format array to create a formatted text
string
...
#### 0.60: 12.10.2           Geospatial measure dictionary
...
#### 0.61: 12.10.3        Geographic coordinate system dictionary
...
#### 0.62: 12.10.4        Projected coordinate system dictionary
...
#### 0.63: 12.10.5           Point data dictionary
...
dictionary     the requirement. See 12.11.4, "Requirement versions". If this entry is absent,
...
or array       dictionaries. Each dictionary identifies a requirement handler that shall be
