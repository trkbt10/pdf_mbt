...
Source: ISO 32000-2:2020, pages 49-67
...
NOTE 2 
Usually, both Flate and LZW encodings compress their input substantially. However, in the worst 
...
boundary. 
NOTE 3 
Although this is not prescribed by the CCITT standard and fax machines never do this, some 
...
NOTE 7 
As specified below, if JPX opacity is used in PDF files, then the JPX data are only allowed to have 
