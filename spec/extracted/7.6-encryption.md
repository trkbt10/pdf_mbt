...
Source: ISO 32000-2:2020, pages 86-110
...
NOTE 1 
A PDF processor can also create an encrypted document without any user interaction if it has 
...
Value 
R 
integer (Required) A number specifying which revision of the standard security 
...
information, see 7.6.4.4, "Password algorithms". 
P 
integer (Required) A set of flags specifying which operations shall be permitted 
...
bit was set to 1. 
NOTE 
For accessibility, ISO 32000-1 had this option restricted by bit 10, but that exception has been 
