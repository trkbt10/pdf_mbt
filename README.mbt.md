...
| Package | Description |
|---------|-------------|
| [`objects`](src/objects/README.md) | Core PDF object types (ISO 32000-2 §7.3) |
| [`lexer`](src/lexer/README.md) | Byte cursor and tokenizer (§7.2) |
| [`parser`](src/parser/README.md) | Recursive descent object parser |
| [`reader`](src/reader/README.md) | File structure, xref, catalog, annotations, actions, forms, signatures |
| [`content`](src/content/README.md) | Content stream parser (~70 operators) |
| [`graphics`](src/graphics/README.md) | Graphics state machine, colour spaces, paths, XObjects |
| [`text`](src/text/README.md) | Text extraction with CMap, font encoding, Unicode mapping |
| [`filters`](src/filters/README.md) | Stream decompression (DEFLATE, LZW, ASCII85, ASCIIHex, RunLength) |
| [`crypto`](src/crypto/README.md) | AES-128/CBC, RC4, MD5, SHA-256/384/512 |
| [`encryption`](src/encryption/README.md) | Encryption handler type model |
| [`common_data`](src/common_data/README.md) | Shared types (dates, rectangles, PDFDocEncoding) |
| [`interchange`](src/interchange/README.md) | Metadata, marked content, file identifiers |
| [`functions`](src/functions/README.md) | PDF computational functions (Type 4 PostScript) |
| [`rendering`](src/rendering/README.md) | Halftone, surface, device rendering abstractions |
